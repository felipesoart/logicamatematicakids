<%@ Page Title="Divisão" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Divisao.aspx.cs" Inherits="KidsLogicaMatematica.Divisao" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <div class="jumbotron" style="background-image: linear-gradient(#ffe8cb, #ffffff)">
        ...
        <table>
            <tr>
                <td colspan="2">
                    <h3>Amiguinho existe uma regra antes de começarmos que é, <b>nenhum número pode ser dividido por zero</b></h3>
